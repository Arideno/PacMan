...
extension Level {
    ...
    static let levelMap1: [[UInt32]] = [
        ...
        [4, 4, 4, 4, 4, 4, 2, 4, 4, 2, 4, 4, 0, 0, 0, 0, 4, 4, 2, 4, 4, 2, 4, 4, 4, 4, 4, 4],
        [2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 4, 0, 0, 0, 0, 0, 0, 4, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2],
        [4, 4, 4, 4, 4, 4, 2, 4, 4, 2, 4, 0, 8, 16, 32, 64, 0, 4, 2, 4, 4, 2, 4, 4, 4, 4, 4, 4],
